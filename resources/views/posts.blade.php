    ...
    <div class="card mb-3">
       ...
       <h11> <div class="position-absolute bg-black px-3 py-2 text-white" style="background-color:rgba(0, 0, 0, 0.5)"><a href="/categories/{{ $posts[0]->category->slug }}" class="text-white text-decoration-none">{{ $posts[0]->category->name }}</a></div></h11>
        ...
        <div class="card-body text-center">
            ...
            <br>
            <h10>
                By : <a href="/author/{{ $posts[0]->author }}" class="text-decoration-none" > {{ $posts[0]->author }} </a>
            </h10>
            <br>
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <h10>
                        By : <a href="/author/{{ $post->user->username }}" class="text-decoration-none" > {{ $post->user->name }} </a>
                    </h10>
                    <br>
